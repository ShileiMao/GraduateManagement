...
-- ----------------------------
BEGIN;
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (11, '删除班级', '班级', 0);
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (12, '创建学院', '学院', 0);
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (13, '审核课题', '课题', 0);
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (14, '创建团队', '团队', 0);
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (15, '答辩小组', '评分表', 0);
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (16, '指导教师', '评分表', 0);
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (17, '删除团队', '团队', 0);
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (18, '查询所有日志', '日志', 0);
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (19, '指导教师', '评分表模板', 0);
-- INSERT INTO `lin_permission` (`id`, `name`, `module`, `mount`) VALUES (20, '更新班级', '班级', 0);
