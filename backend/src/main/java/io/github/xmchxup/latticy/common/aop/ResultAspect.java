package io.github.xmchxup.latticy.common.aop;

import cn.hutool.core.util.StrUtil;
import io.github.xmchxup.latticy.common.configuration.CodeMessageConfiguration;
import io.github.xmchxup.latticy.vo.UnifyResponseVO;
...
public class ResultAspect {
    @AfterReturning(returning = "result", pointcut = "execution(public * io.github.xmchxup.latticy.controller..*.*(..))")
