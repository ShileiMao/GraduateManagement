...
import io.github.xmchxup.latticy.common.LocalUser;
import io.github.xmchxup.latticy.dto.user.ChangePasswordDTO;
import io.github.xmchxup.latticy.dto.user.LoginDTO;
import io.github.xmchxup.latticy.dto.user.RegisterDTO;
import io.github.xmchxup.latticy.dto.user.UpdateInfoDTO;
...
import io.github.xmchxup.latticy.vo.UserPermissionVO;
...
public class UserController {
    ...
    public CreatedVO register(@RequestBody  RegisterDTO validator) {
    ...
    public UserInfoVO getInformation() {
        ...
        System.out.println("loggedin user: " + user.toString() + ", group: " + groups);
